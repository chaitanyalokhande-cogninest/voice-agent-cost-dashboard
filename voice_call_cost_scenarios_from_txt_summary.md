...
| Metric | Value |
|---|---:|
| Successful calls in source CSV | 612 |
| Excluded/error rows | 0 |
| Measured call minutes | 2649.535 |
| Agent turns used as call proxies | 6277 |
| RAG transcript candidates | 349 |
| Tool transcript candidates | 1273 |
| Unattributed TXT speaker segments | 436 |
| Base STT cost | $15.8972 |
| Base TTS cost | $12.9102 |
| Base LLM cost | $4.9168 |
| Base estimated total | $33.7242 |
| Base estimated cost per successful call | $0.0551 |
| Base estimated cost per measured minute | $0.012728 |
